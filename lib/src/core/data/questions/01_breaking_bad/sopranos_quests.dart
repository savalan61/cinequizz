...
final season_1_sopranos = [
  ...
  const QuestionEntity(
    ...
    opts: ['A.J.', 'Carmela', 'Tony', 'Adrianna'],
    answerNo: 1,
  ),
  const QuestionEntity(
    questionId: 'q5',
...
final season_2_sopranos = [
  ...
  const QuestionEntity(
    ...
    opts: ['Diabetes', 'Heart Disease', 'Alzheimer\'s', 'Cancer'],
    answerNo: 3,
  ),
  const QuestionEntity(
    questionId: 'q15',
...
final season_4_sopranos = [
  ...
  const QuestionEntity(
    ...
    opts: ['A car', 'A house', 'Jewelry', 'A fur coat'],
    answerNo: 3,
  ),
  const QuestionEntity(
    questionId: 'q33',
  ...
  const QuestionEntity(
    ...
    opts: ['Furio Giunta', 'Ralph Cifaretto', 'Johnny Sack', 'Feech La Manna'],
    answerNo: 4,
  ),
  const QuestionEntity(
    questionId: 'q35',
...
final season_5_sopranos = [
  const QuestionEntity(
    ...
    opts: ['Feech La Manna', 'Johnny Sack', 'Phil Leotardo', 'Tony Blundetto'],
    answerNo: 4,
  ),
  const QuestionEntity(
    questionId: 'q42',
...
final season_6_sopranos = [
  ...
  const QuestionEntity(
    ...
    opts: ['Real estate', 'Casinos', 'Restaurants', 'Wine import'],
    answerNo: 1,
  ),
  const QuestionEntity(
    questionId: 'q54',
