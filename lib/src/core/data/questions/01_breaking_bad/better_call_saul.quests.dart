...
final betterCallSaulSeason_1 = [
  ...
  const QuestionEntity(
    ...
    opts: ['Saul Goodman', 'Joe Legal', 'Mr. Law', 'John Justice'],
    answerNo: 1,
  ),
  const QuestionEntity(
    questionId: 'q9',
...
final betterCallSaulSeason_3 = [
  ...
  const QuestionEntity(
    ...
    opts: ['Los Pollos Hermanos', 'Mesa Verde', 'HHM', 'Sandpiper Crossing'],
    answerNo: 1,
  ),
  const QuestionEntity(
    questionId: 'q23',
...
final betterCallSaulSeason_6 = [
  ...
  const QuestionEntity(
    ...
    opts: [
      'Building a new law firm',
      'Defending a drug lord',
      'A pro bono clinic',
      'Starting a family'
    ],
    answerNo: 3,
  ...
  const QuestionEntity(
    ...
    opts: [
      ...
      'Managing the Cinnabon',
      'Hiding from the cartel'
    ],
    answerNo: 2,
  ),
  const QuestionEntity(
...
final allBetterCallSaulsQuestions = [
  betterCallSaulSeason_1,
  betterCallSaulSeason_2,
  betterCallSaulSeason_3,
  betterCallSaulSeason_4,
